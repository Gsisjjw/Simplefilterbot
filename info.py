...
# Bot information
API_ID = environ.get('API_ID', '25377875')
if len(API_ID) == 0:
...
# Bot Admins
ADMINS = environ.get('ADMINS', '2034654684')
if len(ADMINS) == 0:
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://Sakunaagain:nehalsingh969797@cluster0.d8lvuik.mongodb.net/?retryWrites=true&w=majority")
...
# Links
SUPPORT_LINK = environ.get('SUPPORT_LINK', 'https://t.me/purpleboat')
OWNER_USERNAME = environ.get("OWNER_USERNAME", "https://t.me/Lordsakunaa")
UPDATES_LINK = environ.get('UPDATES_LINK', 'https://t.me/purplebotz')
FILMS_LINK = environ.get('FILMS_LINK', 'https://t.me/+ylvI8ZZcge80MWRl')
TUTORIAL = environ.get("TUTORIAL", "https://t.me/ezpzsupport/6")
VERIFY_TUTORIAL = environ.get("VERIFY_TUTORIAL", "https://t.me/ezpzsupport/6")
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://graph.org/file/49db7ce16412f4abf5d83.jpg')

# for stream
IS_STREAM = is_enabled('IS_STREAM', True)
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1001748572062")
